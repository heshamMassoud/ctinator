...
public class MessageService {
    ...
    /**
     * Sends the passed {@code message} to the stride conversation defined by the passed {@link UserContext}.
     *
     ...
     */
    @Nonnull
    public CompletableFuture<EntityCreatedResponse> send(@Nonnull final ConversationContext context,
                                                         @Nonnull final Document message) {
        return strideClient.message()
                           .send(message)
